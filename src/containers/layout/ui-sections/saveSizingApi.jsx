...
const saveSizingApi = async (props) => {
    let Result
        let data={
        ...
        "ENABLE_MCAS": "Y",
        "APPROVAL_REQ_FLAG": "Y",
        "WARNING_MESSAGE": "XXIBE_PA_MSG_GEF_LOW_SOPDP_RMT,XXIBE_PA_MSG_MGF_VIO_OPRDP_RMT,XXIBE_PA_MSG_MPR_VIO_OPRDP_RMT,XXIBE_PA_MSG_MSDP_VIO_OPDP_RMT",
